...
const renderLanguages = (languages) => {
	// Esta secao so e renderizada se o JSON tiver "languages"
	// e o HTML tiver um elemento com id="language-list".
	// Caso contrario, e ignorada silenciosamente (nao gera erro).
